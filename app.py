...
# Streamlit App
st.title("🦠 Predict Your Disease Based on Your Symptoms!")
...
st.markdown(f'<div style="border: 0px solid grey; background-color:rgb(39, 39, 54); padding: 10px; border-radius: 10px; font-size: 20px; font-weight: bold; text-align: center;">{predicted_disease}</div>', unsafe_allow_html=True)
